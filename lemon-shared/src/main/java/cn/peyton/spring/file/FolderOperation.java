 ...
 * @create date: 2018/11/16 15:14
 * @author: <a href="http://www.peyton.cn">peyton</a>
 * @version: 1.0.0
 * </pre>
 */
public class FolderOperation implements Serializable {
	/** */
	...
	public static void main(String[] args) { 
		//System.out.println(createNewFile("L:\\datebases\\2.html"));
//		System.out.println(createDirectory("L:\\datebases\\test"));
		//System.out.println(rename("L:\\datebases\\test2","test3"));
//		List<File> lists = new ArrayList<File>();
//		File file = new File("M:\\priture_20110412\\20140801001");
//		searchKeywordsFile(lists , file ,"522_174",true);
//		for (int i = 0; i < lists.size(); i++) {
//			System.out.println(lists.get(i).getName());
//			System.out.println(lists.get(i).getPath());
//			System.out.println("==================");
//		}
//		
...
//		List<File> lists = new ArrayList<File>();
//		searchAllFile(lists, "M:\\priture_20110412\\20140801001",true);
//		
//		for (int i = 0; i < lists.size(); i++) {
//			System.out.println("照片名称: " + lists.get(i).getName());
//			System.out.println("照片位置: " + lists.get(i).getPath());
//			System.out.println("=============================================== ");
//		}
//		System.out.println("共找到:" + lists.size() + " 张照片。");
	}
