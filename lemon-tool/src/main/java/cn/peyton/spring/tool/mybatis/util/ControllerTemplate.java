 ...
 * ProjectName: lemon
 * PackageName: cn.peyton.spring.tool.mybatis.util.ControllerTemplate.java
...
public class ControllerTemplate extends BaseTemplate {
     ...
     * @return
     */
    public static String create(String objName, String path, String importPackagePrefix, String packageName) {
        sb = new StringBuffer();
