...
<div class="iframe-child">
    ...
    <div class="ud-search-container">
        <label for="warehouse-search">名称</label>
        <input type="text" name="name" id="warehouse-search" placeholder="请输入关键字" class="text ui-widget-content ui-corner-all">
        <button class="btn btn-primary ud-radius warehouse-search-btn">
    ...
    <div class="col-xs-12">
        <div class="table-header">
            仓库列表&nbsp;&nbsp;
            <a class="green" href="#">
                <i class="ace-icon fa fa-plus-circle orange bigger-130 warehouse-add"></i>
            </a>
        </div>
...
<script type="application/javascript">
    $(function () {
        ...
        $(".warehouse-search-btn").click(function (e) {
            e.preventDefault();
            e.stopPropagation();
            var keyword = $("#warehouse-search").val();
