...
<script type="text/javascript">
    $(function () {
        var roleMap = {};
        var lastRoleId = -1; // 选中最后一个RoleID
        var selectFirstTab = true;//标识 选中Tab[默认选中第一个Tab]
        var hasMultiSelect = false;  //是否有多选
        ...
        function bindRoleClick() {
            ...
            $(".role-edit").click(function (e) {
                e.preventDefault(); //阻止默认 事件
                e.stopPropagation(); //阻止默认的冒泡 事件
                ...
                $("#dialog-role-form").dialog({
                    ...
                    buttons: {
                        "修改": function (e) {
                            e.preventDefault();
                            updateRole(false, function (data) { //调用 方法 9.
                                clearData("roleForm");
            ...
            $(".role-name").click(function (e) {
                ...
                handleRoleSelected(roleId); //调用 方法 4.
            });
        }
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.status == 200) {
                        ...
                        renderRoleTree(result.data);  //调用方法 7.
                    } else {
        ...
        function renderRoleTree(aclModuleList) {
            zTreeObj = [];
            recursivePrepareTreeData(aclModuleList); //调用 方法 8.
        ...
        function recursivePrepareTreeData(aclModuleList) {
            ...
            if (aclModuleList && aclModuleList.length > 0) {
                $(aclModuleList).each(function (i, aclModule) {
                    ...
                    recursivePrepareTreeData(aclModule.aclModuleList);  //递归 调用 自身方法.
                });
            }
        }
        ...
        $(".role-add").click(function () {
            $("#dialog-role-form").dialog({
                ...
                buttons: {
                    "添加": function (e) {
                        e.preventDefault();
                        updateRole(true, function (data) {  //调用 方法 9.
                            clearData("roleForm");
                            $("#dialog-role-form").dialog("close");
                        }, function (data) {
        ...
        $("#roleTab a[data-toggle='tab']").on("shown.bs.tab", function (e) {
            ...
            if (e.target.getAttribute("href") == '#roleAclTab') {
                selectFirstTab = true;
                loadRoleAcl(lastRoleId);  //调用 方法 5.
            } else {
                selectFirstTab = false;
                loadRoleUser(lastRoleId); //调用 方法 10.
            }
        });
