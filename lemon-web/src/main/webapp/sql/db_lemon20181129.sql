...
-- ----------------------------
INSERT INTO `sys_category` VALUES (1, 0, '基础设置', '#', 'menu-icon fa fa-wrench', 'arrow fa fa-angle-down', 1, 1, 3);
INSERT INTO `sys_category` VALUES (2, 0, '权限管理', '#', 'menu-icon fa fa-user', 'arrow fa fa-angle-down', 2, 1, 3);
INSERT INTO `sys_category` VALUES (3, 0, '日志管理', '#', 'menu-icon fa fa-file-text-o', 'arrow fa fa-angle-down', 3, 1, 3);
INSERT INTO `sys_category` VALUES (4, 0, '系统管理', '#', 'menu-icon fa fa-cogs', 'arrow fa fa-angle-down', 4, 1, 3);
INSERT INTO `sys_category` VALUES (5, 1, '货运类型', '/sys/ft/freighttype.page', 'menu-icon fa fa-caret-right', '', 1, 1, 3);
INSERT INTO `sys_category` VALUES (6, 1, '仓库管理', '/sys/wh/warehouse.page', 'menu-icon fa fa-caret-right', '', 2, 1, 3);
INSERT INTO `sys_category` VALUES (7, 1, '运输管理', '/sys/sp/shipping.page', 'menu-icon fa fa-caret-right', '', 3, 1, 3);
INSERT INTO `sys_category` VALUES (8, 2, '用户管理', '/sys/dept/dept.page', 'menu-icon fa fa-caret-right', '', 1, 1, 3);
INSERT INTO `sys_category` VALUES (9, 2, '角色管理', '/sys/role/role.page', 'menu-icon fa fa-caret-right', '', 2, 1, 3);
INSERT INTO `sys_category` VALUES (10, 2, '权限管理', '/sys/aclModule/acl.page', 'menu-icon fa fa-caret-right', '', 3, 1, 3);
INSERT INTO `sys_category` VALUES (11, 3, '权限日志', '/', 'menu-icon fa fa-caret-right', '', 1, 1, 3);
INSERT INTO `sys_category` VALUES (12, 3, '异常日志', '/', 'menu-icon fa fa-caret-right', NULL, 2, 1, 3);
INSERT INTO `sys_category` VALUES (13, 3, '员工日志', '/', 'menu-icon fa fa-caret-right', NULL, 3, 1, 3);
INSERT INTO `sys_category` VALUES (14, 3, '顾客日志', '/', 'menu-icon fa fa-caret-right', NULL, 4, 1, 3);
INSERT INTO `sys_category` VALUES (15, 3, '供应商日志', '/', 'menu-icon fa fa-caret-right', '', 5, 1, 3);
INSERT INTO `sys_category` VALUES (16, 3, '登录日志', '/', 'menu-icon fa fa-caret-right', NULL, 6, 1, 3);
INSERT INTO `sys_category` VALUES (17, 4, '全局配置管理', '/sys/wc/webconfig.page', 'menu-icon fa fa-caret-right', NULL, 1, 1, 3);
INSERT INTO `sys_category` VALUES (18, 4, '栏目设置', '/sys/cate/category.page', 'menu-icon fa fa-caret-right', NULL, 2, 1, 3);
INSERT INTO `sys_category` VALUES (19, 4, '栏目设置', '/', 'menu-icon fa fa-caret-right', '', 2, 0, 2);
INSERT INTO `sys_category` VALUES (20, 0, '测试', '', 'menu-icon fa fa-caret-right', '', 5, 0, 2);
INSERT INTO `sys_category` VALUES (21, 0, '商品管理', '#', 'menu-icon glyphicon glyphicon-th-list', 'arrow fa fa-angle-down', 1, 1, 2);
INSERT INTO `sys_category` VALUES (22, 21, '颜色管理', '/sys/color/color.page', 'menu-icon fa fa-caret-right', '', 10, 1, 2);
INSERT INTO `sys_category` VALUES (23, 21, '产地管理', '/sys/origin/origin.page', 'menu-icon fa fa-caret-right', '', 9, 1, 2);
INSERT INTO `sys_category` VALUES (24, 21, '品牌管理', '/sys/brand/brand.page', 'menu-icon fa fa-caret-right', '', 8, 1, 2);
INSERT INTO `sys_category` VALUES (25, 21, '商品分类管理', '/sys/coso/commoditysort.page', 'menu-icon fa fa-caret-right', '', 2, 1, 2);
INSERT INTO `sys_category` VALUES (26, 21, '商品类目管理', '/sys/coca/commoditycategory.page', 'menu-icon fa fa-caret-right', NULL, 1, 1, 2);
INSERT INTO `sys_category` VALUES (27, 0, '图片管理', '#', 'menu-icon  glyphicon  glyphicon-picture ', 'arrow fa fa-angle-down', 1, 1, 2);
INSERT INTO `sys_category` VALUES (28, 27, '图片管理', '/', '	menu-icon fa fa-caret-right', '', 1, 1, 2);
INSERT INTO `sys_category` VALUES (29, 27, '图片分类管理', '/', '	menu-icon fa fa-caret-right', '', 2, 1, 2);
INSERT INTO `sys_category` VALUES (30, 0, '供应商管理', '#', 'menu-icon glyphicon glyphicon-user', 'arrow fa fa-angle-down', 3, 1, 2);
INSERT INTO `sys_category` VALUES (31, 30, '供应商管理', '/sys/sup/sys-sup.page', 'menu-icon fa fa-caret-right', '', 1, 1, 2);
INSERT INTO `sys_category` VALUES (32, 21, '商品管理', '/sys/comm/commodity.page', 'menu-icon fa fa-caret-right', '', 0, 1, 2);
INSERT INTO `sys_category` VALUES (33, 21, '出入库管理', '/sys/stor/storage.page', 'menu-icon fa fa-caret-right', '', 0, 1, 2);
INSERT INTO `sys_category` VALUES (34, 21, '主库存管理', '/sys/inve/inventory.page', 'menu-icon fa fa-caret-right', '', 0, 1, 2);
INSERT INTO `sys_category` VALUES (35, 0, '会员管理', '#', 'menu-icon fa fa-user', 'arrow fa fa-angle-down', 2, 1, 2);
INSERT INTO `sys_category` VALUES (36, 35, '地区管理', '/sys/regi/region.page', 'menu-icon fa fa-caret-right', '', 1, 1, 2);
INSERT INTO `sys_category` VALUES (37, 35, '客户等级管理', '/sys/cugr/customergrade.page', 'menu-icon fa fa-caret-right', '', 1, 1, 2);
INSERT INTO `sys_category` VALUES (38, 35, '付款方式管理', '/sys/pamo/paymentmode.page', 'menu-icon fa fa-caret-right', '', 2, 1, 2);
INSERT INTO `sys_category` VALUES (39, 35, '会员管理', '/sys/cus/sys-cus.page', 'menu-icon fa fa-caret-right', '', 0, 1, 2);
...
CREATE TABLE `sys_log`  (
  ...
  `target_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '基于type后指定的对象id，比如用户、权限、角色等表的主键',
...
INSERT INTO `sys_log` VALUES (23, 5, '1', '{\"id\":1,\"name\":\"产品管理员\",\"type\":1,\"status\":1,\"operator\":\"Admin\",\"operateTime\":1508042567000,\"operateIp\":\"127.0.0.1\"}', '{\"id\":1,\"name\":\"产品管理员\",\"type\":1,\"status\":1,\"operator\":\"admin\",\"operateTime\":1542680920146,\"operateIp\":\"127.0.0.1\"}', 'admin', '2018-11-20 10:28:41', '127.0.0.1', 0);
INSERT INTO `sys_log` VALUES (24, 9, '5', '', '{\"id\":5,\"postName\":\"业务员\"}', 'admin', '2018-11-20 10:58:44', '127.0.0.1', 0);
INSERT INTO `sys_log` VALUES (25, 9, '5', '{\"id\":5,\"postName\":\"业务员\"}', '{\"id\":5,\"postName\":\"业务员1\",\"postExplain\":\"业务员\"}', 'admin', '2018-11-20 10:58:58', '127.0.0.1', 0);
INSERT INTO `sys_log` VALUES (26, 9, '5', '{\"id\":5,\"postName\":\"业务员1\",\"postExplain\":\"业务员\"}', '{\"id\":5,\"postName\":\"业务员1\"}', 'admin', '2018-11-20 10:59:03', '127.0.0.1', 0);
...
INSERT INTO `sys_post` VALUES (5, '业务员1', '');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '产品管理员', 1, 1, '', 'admin', '2018-11-20 10:28:40', '127.0.0.1');
...
-- Records of tb_brand
-- ----------------------------
INSERT INTO `tb_brand` VALUES (1, 1, '/img/logo/c86f9d6b543f4d4b866d639c05ea0ef3.jpg', '优朋', 'zh-CN', 1, 0, '测试数据1');
INSERT INTO `tb_brand` VALUES (2, 18, '/img/logo/bc8cbe69f8d64962997bfd1247825f46.jpg', '高盛', 'zh-CN', 0, 1, '测试数据124');
INSERT INTO `tb_brand` VALUES (3, 7, '/img/logo/0187368ca73343ea90e5b28450242acc.png', '欧米', '中国', 2, 1, '测试数据');
...
-- Records of tb_color
-- ----------------------------
INSERT INTO `tb_color` VALUES (1, '黑咖啡色', '');
INSERT INTO `tb_color` VALUES (2, '黑色', '');
INSERT INTO `tb_color` VALUES (3, '红色', '');
INSERT INTO `tb_color` VALUES (4, '青色', '');
INSERT INTO `tb_color` VALUES (5, '橙色', '');
INSERT INTO `tb_color` VALUES (6, '灰色', '');
INSERT INTO `tb_color` VALUES (7, '紫色', '');
INSERT INTO `tb_color` VALUES (8, '粉红色', '');
INSERT INTO `tb_color` VALUES (9, '兰色', '');
INSERT INTO `tb_color` VALUES (10, '大红', '');
INSERT INTO `tb_color` VALUES (11, '黄色', '');
INSERT INTO `tb_color` VALUES (12, '深灰', '');
...
INSERT INTO `tb_commodity_sort` VALUES (15, '双十一', '双十一');
...
-- ----------------------------
INSERT INTO `tb_customer` VALUES (1, '张无忌', 'zhangwuji', NULL, 'B8BE73AFFC241BE33B935CABB3D2511C', '059183260000', '13599129876', '测试数据1', '123456', '059183260001', '960672588@qq.com', '1991-03-15 00:00:00', '350127199103155231', 0, 1, 0, 9, 3, '2018-11-06 16:10:26', '2018-11-09 16:53:46', 1, 'ngbOfGIbaU', '127.0.0.1', '测试数据1');
INSERT INTO `tb_customer` VALUES (2, '乔峰', 'qiaofeng', NULL, '0EE20ECBD0B2DA452DDF77E588F04D68', '01077456698', '13012345678', '测试数据', '256434', '059183260001', 'qiaofeng@qq.com', '1980-02-06 00:00:00', '350127198002065324', 0, 1, 0, 7, 4, '2018-11-06 16:12:48', '2018-11-12 11:04:13', 0, 'dGVaDMXTCu', '127.0.0.1', '测试数据');
INSERT INTO `tb_customer` VALUES (3, '壹叶知秋', 'yi', NULL, 'C389CB42C9A7F1D24E5CA8705C3B902F', '059183260000', '', '', '', '', '', NULL, '', 0, 0, 0, 16, 17, '2018-11-12 11:12:12', '2018-11-12 16:11:09', 1, 'eusBmPERij', '127.0.0.1', '');
INSERT INTO `tb_customer` VALUES (4, 'xialong', 'xiaolong', NULL, 'C3D8CCCD8D312E62F512A2C13BA4B9AB', '02063124578', '13599129888', '测试数据 。。。。', '1259874', '02063124578', '1259874@qq.com', '1980-01-01 00:00:00', '510283198001015631', 0, 1, 0, 9, 4, '2018-11-13 09:46:36', '2018-11-13 09:46:36', 1, 'MbxlUFzPQX', '127.0.0.1', '测试数据 。。。。');
INSERT INTO `tb_customer` VALUES (5, '花无缺', 'fa', NULL, '539C0F49F8E6A47B2BB5AE003F5F6928', '', '', '', '', '', '', NULL, '', 0, 0, 0, 6, 17, '2018-11-13 09:49:00', '2018-11-13 09:49:00', 1, 'QaDYrYMmkj', '127.0.0.1', '');
INSERT INTO `tb_customer` VALUES (6, '剑十三', 'jian', NULL, '83DB967C9B1A65DF170368E93CD0EE0C', '', '', '', '', '', '', NULL, '', 0, 3, 0, 6, 2, '2018-11-13 10:00:07', '2018-11-13 10:00:07', 1, 'AIpTmIuyiD', '127.0.0.1', '');
...
-- ----------------------------
INSERT INTO `tb_inventory` VALUES (1, '2018-10-26 08:56:24', '9:21,10:48,11:40,12:50', 1, ' 包包女2018新款潮时尚真皮手提包韩版女包百搭斜挎包简约女士大包', 196, 3, '2a5c882f-d47e-4cba-bfd5-aa4718621395', '9号仓库');
INSERT INTO `tb_inventory` VALUES (2, '2018-10-26 15:52:48', '11:40,7:10', 1, '复古圆筒水桶包女包小挎包真皮斜跨包植鞣牛皮手工包学院风硬皮包', 50, 2, '9260fc14-3c54-47a8-a33b-11a6ab0ed6c7', '12仓库');
...
-- ----------------------------
INSERT INTO `tb_origin` VALUES (1, '广州', '');
INSERT INTO `tb_origin` VALUES (2, '北京', '');
INSERT INTO `tb_origin` VALUES (3, '郑州', '');
INSERT INTO `tb_origin` VALUES (4, '厦门', '');
INSERT INTO `tb_origin` VALUES (5, '义乌', '');
INSERT INTO `tb_origin` VALUES (6, '上海', '');
INSERT INTO `tb_origin` VALUES (7, '白沟', '');
INSERT INTO `tb_origin` VALUES (8, '邵东', '');
INSERT INTO `tb_origin` VALUES (9, '长沙', '');
INSERT INTO `tb_origin` VALUES (10, '江西', '');
INSERT INTO `tb_origin` VALUES (12, '深圳', '特区');
...
-- ----------------------------
INSERT INTO `tb_region` VALUES (1, '福建省', '000', 1, '0', 0);
INSERT INTO `tb_region` VALUES (2, '福州市', '1', 1, '0.1', 1);
INSERT INTO `tb_region` VALUES (3, '台江区', '1', 1, '0.1.2', 2);
INSERT INTO `tb_region` VALUES (4, '晋安区', '1', 2, '0.1.2', 2);
INSERT INTO `tb_region` VALUES (5, '广东省', '25', 1, '0', 0);
INSERT INTO `tb_region` VALUES (6, '河南省', '1', 1, '0', 0);
INSERT INTO `tb_region` VALUES (7, '广州市', '1', 1, '0.5', 5);
INSERT INTO `tb_region` VALUES (8, '厦门市', '1', 1, '0.1', 1);
INSERT INTO `tb_region` VALUES (9, '泉州市', '1', 1, '0.1', 1);
INSERT INTO `tb_region` VALUES (10, '莆田市', '1', 1, '0.1', 1);
INSERT INTO `tb_region` VALUES (11, '深圳', '1', 1, '0.5', 5);
INSERT INTO `tb_region` VALUES (12, '汕头', '1', 1, '0.5', 5);
INSERT INTO `tb_region` VALUES (13, '龙岩', '1', 1, '0.1', 1);
INSERT INTO `tb_region` VALUES (14, '新疆', '1', 5, '0', 0);
INSERT INTO `tb_region` VALUES (15, '晋安', '', 5, '0.1.2', 2);
INSERT INTO `tb_region` VALUES (16, '测试', '', 6, '0', 0);
...
-- ----------------------------
INSERT INTO `tb_storage` VALUES (1, '2018-10-26 08:56:24', '2018-10-26 08:56:24', 0, 1, 199, ' 包包女2018新款潮时尚真皮手提包韩版女包百搭斜挎包简约女士大包', '/img/product/95b1bff0af9249c79488844bb3d81c01.jpg', '9号仓库', 'Judy', 3, '2a5c882f-d47e-4cba-bfd5-aa4718621395', 1);
INSERT INTO `tb_storage` VALUES (2, '2018-10-26 09:17:22', '2018-10-26 09:54:13', 1, 2, 37, ' 包包女2018新款潮时尚真皮手提包韩版女包百搭斜挎包简约女士大包', '/img/product/95b1bff0af9249c79488844bb3d81c01.jpg', '9号仓库', 'Judy', 3, '2a5c882f-d47e-4cba-bfd5-aa4718621395', 1);
INSERT INTO `tb_storage` VALUES (3, '2018-10-26 09:21:50', '2018-10-26 09:21:50', 1, 1, 40, ' 包包女2018新款潮时尚真皮手提包韩版女包百搭斜挎包简约女士大包', '/img/product/95b1bff0af9249c79488844bb3d81c01.jpg', '9号仓库', 'Judy', 3, '2a5c882f-d47e-4cba-bfd5-aa4718621395', 1);
INSERT INTO `tb_storage` VALUES (4, '2018-10-26 15:52:48', '2018-10-26 15:52:48', 0, 1, 50, '复古圆筒水桶包女包小挎包真皮斜跨包植鞣牛皮手工包学院风硬皮包', '/img/product/084a41a5bb41407783cc7f0980300381.jpg', '12仓库', 'Judy', 2, '9260fc14-3c54-47a8-a33b-11a6ab0ed6c7', 1);
...
-- ----------------------------
INSERT INTO `tb_supplier` VALUES (1, '名盛', '名盛', NULL, '471F1CD5E2C4937D528F9B9E9863A2B6', '057612345678', '13255668899', '测试数据 ', '1235678', '057612345678', 'minsen@qq.com', 0, 1, '2018-09-18 22:40:47', '2018-09-20 19:18:05', 'CEUIOqemPC', '127.0.0.1', '测试数据 ', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (2, '名盛1', '名盛1', NULL, '0AFBE037D95C05B4E1ED9DDE3E474420', '075512345678', '13922338765', '广东深圳', '968877', '075512345678', '12345678@tom.com', 0, 1, '2018-09-20 18:39:33', '2018-09-20 19:17:01', 'iEEjyEooms', '127.0.0.1', '测试数据', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (3, '利圆', '利圆', NULL, 'A6CB5B4B2BB705EC70B6F99A0BBA993D', '', '', '利圆', '', '', '', 0, 1, '2018-09-20 19:01:47', '2018-09-20 19:01:47', 'EpttFRYZNk', '127.0.0.1', '利圆', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (4, '测试', '测试', NULL, '4733290C5FDB14267166FFBE68A5B78D', '', '', '', '', '', '', 0, 1, '2018-09-20 20:52:32', '2018-09-20 20:52:32', 'UDzDFEXTXt', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (5, '测试', '测试1', NULL, '349360B52DF5D32A4F74DFB4FFFF5F8B', '', '', '', '', '', '', 0, 1, '2018-09-20 20:53:54', '2018-09-20 20:53:54', 'dbdPBkfcVr', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (6, '优朋', '优朋', NULL, '8B7DDCB7B2C6EFB1BDD5BB09B7B5E56F', '02088556644', '13255998866', '广东省广州市三元里。。。', '6547894521', '02088556644', 'youpan@ba.com', 0, 1, '2018-09-20 22:12:08', '2018-09-20 22:12:08', 'VOPxouPBVP', '127.0.0.1', '这是一组测试数据', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (7, '欧米', '欧米', NULL, 'AA5846999D30779461C1CB767A32397E', '', '', '', '', '', '', 0, 1, '2018-09-20 22:20:14', '2018-09-20 22:20:14', 'CeyyqdUfoC', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (8, 'Jeep', 'Jeep', NULL, '04777A17A04B448D9AA3931DD5F9148C', '02086347956', '13825893654', '广东省广州市三元里', '120456789', '02086347956', 'Jeep@qq.com', 0, 1, '2018-09-20 22:26:07', '2018-09-20 22:26:52', 'VkytlaQazW', '127.0.0.1', '测试数据', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (9, '盛大', '盛大', NULL, 'EA049B14CA4C2936A7396AA51A7752F7', '', '', '', '', '', '', 0, 1, '2018-09-20 22:31:17', '2018-09-20 22:31:17', 'aVBXCyjiAb', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (10, '测试2', '测试2', NULL, 'A288E252165566431C3F3C439D377C69', '', '', '', '', '', '', 0, 1, '2018-09-20 22:38:49', '2018-09-20 22:38:49', 'XqGdMmoZCP', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (11, '测试3', '测试3', NULL, 'BE7683834896246FBD1B2DC06A5F8152', '', '', '', '', '', '', 0, 1, '2018-09-20 22:43:25', '2018-09-20 22:43:25', 'NIsDlmGYsp', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (12, '测试4', '测试4', NULL, '8B39CBA95A1F0E3AF7761A7FE1CC5129', '', '', '', '', '', '', 0, 1, '2018-09-20 22:44:35', '2018-09-20 22:44:35', 'iRBCghmtnx', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (13, '测试5', '测试5', NULL, '684F5124A122AABA1ADFAF4C499464EA', '', '', '', '', '', '', 0, 1, '2018-09-20 22:45:27', '2018-09-20 22:45:27', 'IDBwNQWekO', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (14, '测试6', '测试6', NULL, '4BF080A8FCE59842EDCCA55578BC1B75', '', '', '', '', '', '', 0, 1, '2018-09-20 22:47:12', '2018-09-20 22:47:12', 'MRERIrBYiW', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (15, '测试7', '测试7', NULL, 'C6398CD99960E5609B29E8D0D139E1C2', '', '', '', '', '', '', 0, 1, '2018-09-20 22:51:06', '2018-09-20 22:51:06', 'PUlxoEQEkE', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (16, '测试8', '测试8', NULL, '1AF0F97D2DD05E980263446EF98B7641', '', '', '', '', '', '', 0, 1, '2018-09-20 22:54:19', '2018-09-20 22:54:19', 'ffQTGsvwfv', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (17, '测试9', '测试9', NULL, 'AE9E57E9EC9C7FF5D404FA87D26D4CB0', '', '', '', '', '', '', 0, 1, '2018-09-20 22:59:25', '2018-09-20 22:59:25', 'QQlFXrZBPP', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (18, '测试10', '测试10', NULL, '472C7F19993E8DC8A0249086FACE9B1C', '', '', '', '', '', '', 0, 1, '2018-09-20 23:00:20', '2018-09-20 23:00:20', 'ejyipqeOVF', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (19, '测试11', '测试11', NULL, '8DE6F3B7C03361A29C4F36269D583984', '', '', '', '', '', '', 0, 1, '2018-09-20 23:02:18', '2018-09-20 23:02:18', 'TbSYOUoxPI', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (20, '测试12', '测试12', NULL, '234A446254DFC176D32058F4DDA7E428', '', '', '', '', '', '', 0, 1, '2018-09-20 23:03:25', '2018-09-20 23:03:25', 'OCeCjPhPxn', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (21, '测试13', '测试13', NULL, '1D65299581575A724299B45936CE8D4D', '', '', '', '', '', '', 0, 1, '2018-09-20 23:05:16', '2018-09-20 23:05:16', 'XXDzFwkfMt', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (22, '测试14', '测试14', NULL, '611F7EAC29F35BDB85B482CC51D01B7D', '', '', '', '', '', '', 0, 1, '2018-09-20 23:06:41', '2018-09-20 23:06:41', 'VusvkpWyWB', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (23, '测试15', '测试15', NULL, '588DF7B8CDEB4042876C2B0187AEA91B', '', '', '', '', '', '', 0, 0, '2018-09-20 23:07:19', '2018-09-20 23:07:19', 'EGueVNoiGI', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (24, '测试16', '测试16', NULL, '4BB087332466341056F8E7EC82B49296', '', '', '', '', '', '', 0, 1, '2018-09-20 23:10:34', '2018-11-12 10:43:40', 'ESQEMCQwxh', '127.0.0.1', '', NULL, NULL, 0);
INSERT INTO `tb_supplier` VALUES (25, '利圆', 'liyuan', NULL, 'C2125AE64D16D8C2886ACD1AE38A51E3', '057699886677', '13512341234', '台州路桥', '125899', '057699886677', '125899@qq.com', 0, 3, '2018-11-13 10:13:10', '2018-11-13 10:13:10', 'PniuFidquW', '127.0.0.1', '测试测试数据中', NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `tb_warehouse` VALUES (1, '13仓库', '059183261633', '13078941234', '测试数据 ', '123999', '123456', '测试数据 ');
INSERT INTO `tb_warehouse` VALUES (2, '12仓库', '059183260000', '13065470000', '仓库1234', '968112', '1236', '说明');
INSERT INTO `tb_warehouse` VALUES (3, '9号仓库', '059186549999', '13012345678', '福建省福州市台江区', '66589', '0', '测试数据');
INSERT INTO `tb_warehouse` VALUES (4, '7号仓库', '059177889966', '13566334477', '', '', '', '');
INSERT INTO `tb_warehouse` VALUES (5, '5号仓库', '059133335566', '', '', '', '', '');
