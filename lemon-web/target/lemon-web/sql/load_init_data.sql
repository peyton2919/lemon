...
INSERT INTO `tb_brand_info` VALUES (2, 18, '/img/logo/bc8cbe69f8d64962997bfd1247825f46.jpg', '高盛', 'zh-CN', 0, 1, '测试数据');
...
-- ----------------------------
INSERT INTO `tb_commodity_category` VALUES (1, 0, '男包', '0', 1, '测试', NULL, '2018-09-15 21:46:18');
INSERT INTO `tb_commodity_category` VALUES (2, 0, '女包', '0', 1, '', '2018-09-15 17:18:04', '2018-09-15 17:18:04');
INSERT INTO `tb_commodity_category` VALUES (3, 1, '测试1', '0.1', 1, '', NULL, '2018-09-15 19:36:57');
INSERT INTO `tb_commodity_category` VALUES (4, 3, '第一', '0.1.3', 1, '', '2018-09-15 17:18:25', '2018-09-15 17:18:25');
INSERT INTO `tb_commodity_category` VALUES (5, 2, '测试2', '0.2', 1, '测试', NULL, '2018-09-15 20:27:30');
INSERT INTO `tb_commodity_category` VALUES (6, 3, '第二', '0.1.3', 2, '测试', NULL, '2018-09-15 20:19:48');
INSERT INTO `tb_commodity_category` VALUES (7, 6, '测试10', '0.1.3.6', 10, '更新', NULL, '2018-09-15 21:12:35');
INSERT INTO `tb_commodity_category` VALUES (8, 6, '测试11', '0.1.3.6', 1, '', '2018-09-15 21:21:17', '2018-09-15 21:21:17');
INSERT INTO `tb_commodity_category` VALUES (9, 7, '测试12', '0.1.3.6.7', 1, '', NULL, '2018-09-15 21:28:33');
INSERT INTO `tb_commodity_category` VALUES (10, 0, '测试10', '0', 1, '', '2018-09-20 23:26:03', '2018-09-20 23:26:03');
INSERT INTO `tb_commodity_category` VALUES (11, 0, '测试11', '0', 1, '', NULL, '2018-09-21 11:17:24');
...
-- ----------------------------
INSERT INTO `tb_commodity_sort` VALUES (1, '热销', NULL);
INSERT INTO `tb_commodity_sort` VALUES (2, '特价', NULL);
INSERT INTO `tb_commodity_sort` VALUES (3, '中秋特价', NULL);
INSERT INTO `tb_commodity_sort` VALUES (4, '周庆', NULL);
INSERT INTO `tb_commodity_sort` VALUES (5, '搜搜', 'test');
INSERT INTO `tb_commodity_sort` VALUES (6, 'test', NULL);
INSERT INTO `tb_commodity_sort` VALUES (7, 'test2', NULL);
INSERT INTO `tb_commodity_sort` VALUES (8, 'test3', NULL);
INSERT INTO `tb_commodity_sort` VALUES (9, 'test4', 'test4');
INSERT INTO `tb_commodity_sort` VALUES (10, '年庆', NULL);
INSERT INTO `tb_commodity_sort` VALUES (11, '特价2', '测试');
...
INSERT INTO `tb_supplier_info` VALUES (24, '测试16', '测试16', NULL, '4BB087332466341056F8E7EC82B49296', '', '', '', '', '', '', 0, 1, '2018-09-20 23:10:34', '2018-09-20 23:10:34', 'ESQEMCQwxh', '127.0.0.1', '', NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `tb_commodity_info` VALUES ('8e3f0758-b210-4665-8406-d3313c0a2d60', '测试数据测试数据测试数据测试数据测试数据', '889654', '测试数据', '', '', '个', 50.00, 158.00, 65.00, '/img/product/bf2157063a0d4ca1adf16ffb765e7299.jpg', '/img/product/2dc535fc80934fdcaedf513a78876cdf,0,1,2,.jpg', 1, 1, '', 0, '<p>\r\n	<u>测试数据</u>\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<strong>测试数据</strong>\r\n</p>\r\n<p>\r\n	测试数据\r\n</p>', '2018-10-09 14:41:50', '2018-10-09 14:41:50', 7, '10,4', 10);
...
CREATE TABLE `tb_storage_info` (
  ...
  stor_created DATETIME  DEFAULT NULL COMMENT '入库时间，默认当前时间',
  stor_updated DATETIME  DEFAULT NULL COMMENT '更新时间',
  ...
  stor_com_name VARCHAR(100) DEFAULT NULL COMMENT '商品名称,用来模糊查找',
  stor_image_url VARCHAR(150) DEFAULT NULL COMMENT '商品图片地址',
  stor_war_name VARCHAR(50) DEFAULT NULL COMMENT '仓库名称',
  stor_emp_name VARCHAR(50) DEFAULT NULL COMMENT '员工名称',
...
CREATE TABLE `tb_inventory_info` (
  ...
  inve_detail VARCHAR(500) DEFAULT NULL COMMENT '颜色编号1:数量,颜色编号2:数量,...颜色编号N:数量',
  inve_tip INT(4) DEFAULT 0 COMMENT '库存提示，1为提示，0不提示，默认为0',
  inve_com_name VARCHAR(100) DEFAULT NULL COMMENT '商品名称,用来模糊查找',
...
CREATE TABLE `tb_region_info` (
  id BIGINT(20) PRIMARY KEY AUTO_INCREMENT COMMENT '编号',
  regi_name VARCHAR(50) NOT NULL COMMENT '名称',
  regi_code VARCHAR(20) DEFAULT NULL COMMENT '地区区码',
  regi_seq INT NOT NULL DEFAULT '0' COMMENT '排序,从小到大排序',
  regi_level VARCHAR(50) DEFAULT NULL COMMENT '地区层级',
...
CREATE TABLE `tb_payment_mode` (
  id INT(11) PRIMARY KEY AUTO_INCREMENT COMMENT '编号',
  pamo_name VARCHAR(50) NOT NULL COMMENT '名称',
  pamo_explain VARCHAR(100) DEFAULT NULL COMMENT '说明'
)ENGINE=InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_customer_info` (
  ...
  cus_avatar VARCHAR(150) DEFAULT NULL COMMENT '顾客头像地址',
